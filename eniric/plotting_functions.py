...
def plot_paper_plots():
    ...
    y1_60k_vsini1 = (
        (np.array(y1_60k_top) - np.array(y1_60k_bottom))
        / np.array(y1_60k_bottom)
        * 100.0
    )
    y1_80k_vsini1 = (
        (np.array(y1_80k_top) - np.array(y1_80k_bottom))
        / np.array(y1_80k_bottom)
        * 100.0
    )
    y1_100k_vsini1 = (
    ...
    y2_60k_vsini1 = (
        (np.array(y2_60k_top) - np.array(y2_60k_bottom))
        / np.array(y2_60k_bottom)
        * 100.0
    )
    y2_80k_vsini1 = (
        (np.array(y2_80k_top) - np.array(y2_80k_bottom))
        / np.array(y2_80k_bottom)
        * 100.0
    )
    y2_100k_vsini1 = (
    ...
    y3_60k_vsini1 = (
        (np.array(y3_60k_top) - np.array(y3_60k_bottom))
        / np.array(y3_60k_bottom)
        * 100.0
    )
    y3_80k_vsini1 = (
        (np.array(y3_80k_top) - np.array(y3_80k_bottom))
        / np.array(y3_80k_bottom)
        * 100.0
    )
    y3_100k_vsini1 = (
    ...
    y4_60k_vsini1 = (
        (np.array(y4_60k_top) - np.array(y4_60k_bottom))
        / np.array(y4_60k_bottom)
        * 100.0
    )
    y4_80k_vsini1 = (
        (np.array(y4_80k_top) - np.array(y4_80k_bottom))
        / np.array(y4_80k_bottom)
        * 100.0
    )
    y4_100k_vsini1 = (
