...
def plot_stellar_spectum(wav_stellar, flux_stellar, wav_atm_selected, mask_atm_selected):
    ...
    plt.ylim(
        np.min(flux_stellar) - 0.1 * (np.max(flux_stellar) - np.min(flux_stellar)),
...
def plot_paper_plots():
    ...
    y1_60k_vsini1 = (
        (np.array(y1_60k_top) - np.array(y1_60k_bottom)) / np.array(y1_60k_bottom) * 100.0
    )
    y1_80k_vsini1 = (
        (np.array(y1_80k_top) - np.array(y1_80k_bottom)) / np.array(y1_80k_bottom) * 100.0
    )
    y1_100k_vsini1 = (
        (np.array(y1_100k_top) - np.array(y1_100k_bottom))
        / np.array(y1_100k_bottom)
        * 100.0
    )

    y2_60k_vsini1 = (
        (np.array(y2_60k_top) - np.array(y2_60k_bottom)) / np.array(y2_60k_bottom) * 100.0
    )
    y2_80k_vsini1 = (
        (np.array(y2_80k_top) - np.array(y2_80k_bottom)) / np.array(y2_80k_bottom) * 100.0
    )
    y2_100k_vsini1 = (
        (np.array(y2_100k_top) - np.array(y2_100k_bottom))
        / np.array(y2_100k_bottom)
        * 100.0
    )

    y3_60k_vsini1 = (
        (np.array(y3_60k_top) - np.array(y3_60k_bottom)) / np.array(y3_60k_bottom) * 100.0
    )
    y3_80k_vsini1 = (
        (np.array(y3_80k_top) - np.array(y3_80k_bottom)) / np.array(y3_80k_bottom) * 100.0
    )
    y3_100k_vsini1 = (
        (np.array(y3_100k_top) - np.array(y3_100k_bottom))
        / np.array(y3_100k_bottom)
        * 100.0
    )

    y4_60k_vsini1 = (
        (np.array(y4_60k_top) - np.array(y4_60k_bottom)) / np.array(y4_60k_bottom) * 100.0
    )
    y4_80k_vsini1 = (
        (np.array(y4_80k_top) - np.array(y4_80k_bottom)) / np.array(y4_80k_bottom) * 100.0
    )
    y4_100k_vsini1 = (
        (np.array(y4_100k_top) - np.array(y4_100k_bottom))
        / np.array(y4_100k_bottom)
        * 100.0
    )
    ...
    ax1.set_xticklabels([])
    ax1.set_ylim(
        positiony_min - 0.1 * (positiony_max - positiony_min),
    ...
    ax1.scatter(
        range(1, len(bands) + 1), y1_60k_vsini1, marker="<", s=100.0, color="b", alpha=0.2
    )
    ax1.scatter(
        range(1, len(bands) + 1), y1_80k_vsini1, marker="<", s=100.0, color="g", alpha=0.2
    )
    ax1.scatter(
        range(1, len(bands) + 1),
        y1_100k_vsini1,
    ...
    ax1.set_xticklabels([])
    ax1.set_ylim(
        positiony_min - 0.05 * (positiony_max - positiony_min),
    ...
    ax2.scatter(
        range(1, len(bands) + 1), y2_60k_vsini1, marker="<", s=100.0, color="b", alpha=0.2
    )
    ax2.scatter(
        range(1, len(bands) + 1), y2_80k_vsini1, marker="<", s=100.0, color="g", alpha=0.2
    )
    ax2.scatter(
        range(1, len(bands) + 1),
        y2_100k_vsini1,
    ...
    ax3.scatter(
        range(1, len(bands) + 1), y3_60k_vsini1, marker="<", s=100.0, color="b", alpha=0.2
    )
    ax3.scatter(
        range(1, len(bands) + 1), y3_80k_vsini1, marker="<", s=100.0, color="g", alpha=0.2
    )
    ax3.scatter(
        range(1, len(bands) + 1),
        y3_100k_vsini1,
    ...
    ax4.scatter(
        range(1, len(bands) + 1), y4_60k_vsini1, marker="<", s=100.0, color="b", alpha=0.2
    )
    ax4.scatter(
        range(1, len(bands) + 1), y4_80k_vsini1, marker="<", s=100.0, color="g", alpha=0.2
    )
    ax4.scatter(
        range(1, len(bands) + 1),
        y4_100k_vsini1,
