...
def test_pdread_2col():
    ...
    spectrum_1 = "tests/data/obsolete/Sample_input_phoenix.dat"
    spectrum_2 = "tests/data/obsolete/Sample_resampled_spectrum_res3.dat"
...
def test_pdread_3col():
    ...
    """
    filename = "tests/data/obsolete/Sample_results_spectrum.dat"
