...
def resample_allfiles(results_dir=results_dir, resampled_dir=resampled_dir, sampling=3.0):
    ...
    [resampler(spectrum_file, results_dir=results_dir, resampled_dir=resampled_dir, sampling=sampling)
     for spectrum_file in onlyfiles if spectrum_file.endswith(".txt")]
