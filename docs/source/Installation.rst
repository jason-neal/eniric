...
``Starfish`` should be automatically installed during installation of ``eniric``. If issues arise regarding ``Starfish`` see `github.com/iance/Starfish <Starfishgithub_>`_:
...
.. code-block:: bash
   ...
   git clone https://github.com/jason-neal/Starfish
   cd Starfish
